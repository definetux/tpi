...
{
    [TestFixture]
    public class SystemFileExplorerTestWithPI
    {
        ...
        /// </summary>
        [Test]
        public void MergeTemporaryFiles_TestWithMock()
        {
            // arrange
            var fileManager = new FakeFileManager();
            var fileExplorer = new SystemFileExplorerWithPI
            {
        ...
        /// </summary>
        [Test]
        public void MergeTemporaryFiles_TestWithMockMoq()
        {
            // arrange  
        ...
        /// </summary>
        [Test]
        public void RemoveTemporaryFiles_TestWithMock()
        {
            // arrange
            var fileManager = new FakeFileManager();
            var fileExplorer = new SystemFileExplorerWithPI()
        ...
        /// </summary>
        [Test]
        public void RemoveTemporaryFiles_TestWithMockMoq()
        {
            // arrange  
            var fileManager = new Mock<IFileManager>();
            ...
            var fileExplorer = new SystemFileExplorerWithPI() { FileManager = fileManager.Object };
